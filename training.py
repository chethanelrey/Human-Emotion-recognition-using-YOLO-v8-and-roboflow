...
api_key = "MkYrDi5tCNV06AFanovb"

# Initialize Roboflow and access the project
rf = Roboflow(api_key)
workspace_name = "chethanelrey"
project_name = "emotion-detection-vnurz-njmzq"
...
results = model.train(
    data='Emotion-Detection-1/data.yaml',  # Path to the training data YAML file
